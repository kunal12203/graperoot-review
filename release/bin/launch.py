...
def write_stop_hook(project: Path, port: int) -> None:
    ...
    stop_py.write_text(
        ...
        "    total_turns = 0\n"
        "    tool_hits_str = '{}'\n"
        "    def _parse_savings(savings):\n"
        "        nonlocal tokens_avoided, tokens_avoided_tar, tokens_avoided_cross_turn\n"
        "        nonlocal shadow_tokens_avoided, graperoot_overhead_tokens, tokens_served\n"
        "        nonlocal unique_files_read, total_reads, total_turns, tool_hits_str\n"
        ...
        "        tokens_served = savings.get('tokens_served', 0)\n"
        "        unique_files_read = savings.get('unique_files_read', 0)\n"
        "        total_reads = savings.get('total_reads', 0)\n"
        "        total_turns = savings.get('total_turns', 0)\n"
        ...
        "            _parse_savings(json.loads(resp.read()))\n"
        "        else:\n"
        ...
        "                _parse_savings(json.loads(open(_cache).read()))\n"
        "        except Exception: pass\n"
